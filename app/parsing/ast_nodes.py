...
Cada clase representa un elemento del pseudocódigo y tendrá métodos para
calcular su complejidad computacional.
"""
...
class Program(ASTNode):
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"Program(classes={classes_count}, "
...
class IfStatement(Statement):
    """Condicional IF con bloque opcional ELSE."""
...
class CallStatement(Statement):
    """Llamada a subrutina: call función(a, b, c)."""
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"CallStatement({self.function_name}, "
            f"args={args_count})"
        )
...
class Variable(Expression):
    ...
    def __repr__(self) -> str:
        ...
        if self.is_range:
            return (
                f"Variable({self.name}[{self.range_start}..{self.range_end}])"
            )
        return f"Variable({self.name})"
...
class BinaryOp(Expression):
    """Operación binaria (+, -, *, /, mod, div, ^, and, or, <, >, ...)."""
...
class FunctionCall(Expression):
    ...
    def __repr__(self) -> str:
        args_count = len(self.arguments)
        return (
            f"FunctionCall({self.function_name}, "
            f"args={args_count})"
        )
